...
public class IsLongPressedName {
    ...
    public static void main(String[] args) {
        IsLongPressedName t = new IsLongPressedName();
        System.out.println(t.isLongPressedName("alex", "aaleex"));
    }

    public boolean isLongPressedName_mine(String name, String typed) {
        ...
        int left = 0, right = 0;
        for (; left < name.length(); left++) {
            boolean findOrigin = false;
            for (; right < typed.length(); right++) {
